...
-- variables
------------------------------------------------------------------------
myFont = "xft:SauceCodePro Nerd Font Mono:regular:size=9:antialias=true:hinting=true" ::String

myModMask = mod4Mask ::KeyMask       -- Sets modkey to super/windows key

myTerminal = "alacritty" ::String    -- Sets default terminal

myBrowser = "google-chrome-stable " ::String -- Sets google chrome as browser

myBrowser2 = "qutebrowser" ::String -- sets qutebrowser as browser

myEmacs = "emacsclient -c -a 'emacs' " ::String -- Makes emacs keybindings easier to type

myEditor = "emacsclient -c -a 'emacs' " ::String -- Sets emacs as editor

myBorderWidth = 2 :: Dimension  -- Sets border width for windows

myNormColor   = colorBack :: String  -- This variable is imported from Colors.THEME
      
myFocusColor  = color15 :: String    -- This variable is imported from Colors.THEME

mySoundPlayer = "ffplay -nodisp -autoexit " :: String-- The program that will play system sounds
...
gsSettings =
  [ ("Pavucontrol", "pavucontrol")
    ...
    , ("Default applications for LXSession", "lxsession-default-apps")
...
gsSystem =
  ...
  , ("Cmatrix", (myTerminal ++ " -e cmatrix"))
  , ("Fish", (myTerminal ++ " -e fish"))
  , ("PCManFM", "pcmanfm")
  , ("Vifm", (myTerminal ++ " -e ./.config/vifm/scripts/vifmrun"))
   ]
...
showKeybindings x = addName "Show Keybindings" $ io $ do
  h <- spawnPipe $ "yad --text-info --fontname=\"SauceCodePro Nerd Font Mono 12\" --fore=#46d9ff back=#282c36 --center --geometry=1200x750 --title \"XMonad keybindings\""
...
myKeys c = (subtitle "Custom Keys":) $ mkNamedKeymap c $
  ...
  , ("M-C-q", addName "Quit XMonad"              $ sequence_ [spawn (mySoundPlayer ++ shutdownSound), io exitSuccess])
  ...
  --screen off
  , ("M-<F3>", addName "screen off"              $ spawn "xset dpms force off")
  --Redshift
  ,("M-r",       addName "temp color screen"       $spawn  "redshift -O 2400")
  ,("M-M1-r",    addName "quit temp color"         $spawn "redshift -x")
  --Scripts
  , ("M-<F2>", addName "random wallpaper"         $spawn "~/.scripts/wallpapers-ramdon/feh")
  , ("M-S-z", addName "keyboard spanish"         $spawn "~/.scripts/keyboard-changer-lenguaje/keyboard-changer-lenguaje.sh up")
  , ("M-z",addName "keyboard english"         $spawn "~/.scripts/keyboard-changer-lenguaje/keyboard-changer-lenguaje.sh down")
  , ("M-s a", addName "screen one"            $spawn "~/.scripts/screen-control/screen.sh up")
  , ("M-s d", addName "screen two"               $spawn "~/.scripts/screen-control/screen.sh down")
  --Dunst
  , ("M-M1-w", addName "Close notification"       $spawn "dunstctl close-all")
  , ("M-c h",  addName "history notification"     $spawn "dunstctl history-pop")
  , ("M-c c",  addName "Close all notification"   $spawn "dunstctl close")
  , ("M-c a",  addName "dunst context"            $spawn "dunstctl context")
  -- Useful programs to have a keybinding for launch
  , ("M-<Return>", addName "Launch terminal"     $ spawn (myTerminal))
  , ("M-b", addName "Launch web browser"         $ spawn (myBrowser))
  , ("M-S-b", addName "Launch web browser qutebrowser"  $spawn (myBrowser2))
  , ("M-M1-h", addName "Launch htop"             $ spawn (myTerminal ++ " -e htop"))
  , ("M-a", addName "pcmanfm"                    $ spawn "pcmanfm")
  -- Kill windows
  ...
  , ("M-u o", addName "mocp stop"                $ spawn "mocp --stop" )
  ...
  ----Brightness
     , ("M-<F5>",addName "brightness up"   $ spawn "~/.scripts/Brightness/brightnessControl up")
     , ("M-<F4>", addName "brightness down" $spawn "~/.scripts/Brightness/brightnessControl down")
  -- Multimedia Keys
  ...
  , ("<XF86AudioMute>", addName "Toggle audio mute"   $ spawn "~/.scripts/volumen-control/changevolume mute")
  , ("<XF86AudioLowerVolume>", addName "Lower vol"    $ spawn "~/.scripts/volumen-control/changevolume down")
  , ("<XF86AudioRaiseVolume>", addName "Raise vol"    $ spawn "~/.scripts/volumen-control/changevolume up")
